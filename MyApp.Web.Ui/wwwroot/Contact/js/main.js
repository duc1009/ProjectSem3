...
function windowLoadInit() {
	...
	jQuery('.toggle_menu').on('click', function(){
		...
		jQuery('#toTop').toggleClass('menu-mobile-active');
	});
...
function windowReadyInit() {
	...
	var breadcrumbsBgNumber = Math.floor(Math.random() * 5) + 1;
	jQuery('.page_breadcrumbs.background_cover').css('background-image', 'url(img/parallax/breadcrumbs' + breadcrumbsBgNumber + '.jpg)');
